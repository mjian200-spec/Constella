...
def make_knowledge_graph_handler(web_dir: Path, data: KnowledgeGraphData) -> Type[SimpleHTTPRequestHandler]:
...
def serve_knowledge_graph(
    ...
    print(f"Constella Knowledge Graph: http://{host}:{port}/ [{dataset_id}]")
    try:
