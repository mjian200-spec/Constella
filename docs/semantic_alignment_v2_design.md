...
2026-08-30的首轮弱标签网格覆盖`candidate=4/6/8`、`objects=8/12/16`和`max_chars=25000/40000`，与当前720个概念相交得到956条弱标签。推荐组合为`8/16/40000`：candidate recall为`0.9121`，按源频率加权为`0.9712`，生成363个package；其中H2弱标签召回为`0.8647`。因此主入口暂采用该组合。该结论仍需固定人工金标准验证，尤其是H2长尾；不能据此宣称语义准确率达到91.21%。
