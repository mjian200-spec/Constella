...
| 名称 | 级别 | 原始依据 | 通过标准 |
|---|---|---|---|
| `test_real_output_contract` | 强 | 全部原始输入 | 正文 Unit 数等于原始块数减去目录前置块数；每个规则 Unit 生成一个文本包；只保留完整资产；正式输出文件齐全。 |
...
| `test_real_table_formula_and_caption_assets_remain_whole_and_linked` | 强 | 索引 641、644、2488、2491、2497 | 整表保留；式（5-21）建立双向公式关联；题注描述只关联完整图。 |
